...
def build_resnet34_lite(input_shape=(128, 128, 1), num_classes=27):
    ...
    model = keras.Model(inputs, outputs, name="ResNet34_Lite_27Sp")
    return model

model = build_resnet34_lite(input_shape=INPUT_SHAPE_128, num_classes=NUM_CLASSES)
...
print("\n--- Training ResNet34-Lite PCEN (4th Architecture for Quad-Ensemble) ---")
...
print(f"\n==========================================")
print(f"ResNet34-Lite PCEN Validation Accuracy: {val_acc*100:.2f}%")
print(f"==========================================")
