...
def build_compact_cnn_hnr(input_shape=(128, 128, 1), num_classes=27):
    ...
    model = keras.Model(inputs, outputs, name="Compact_CNN_27Sp_HNR")
    return model

model = build_compact_cnn_hnr(input_shape=INPUT_SHAPE, num_classes=NUM_CLASSES)
...
MODEL_SAVE_PATH = os.path.join(DATASET_DIR, 'best_model_compact_27sp_hnr.keras')
...
print("\n--- Lancement de l'Entraînement Compact CNN 27-Espèces HNR ---")
...
print(f"\n==========================================")
print(f"Meilleure Précision de Validation Compact CNN 27-Espèces HNR: {val_acc*100:.2f}%")
print(f"==========================================")
...
plt.title('Compact CNN 27-Espèces HNR Accuracy')
plt.legend()

plt.subplot(1, 2, 2)
plt.plot(history.history['loss'], label='Train Loss')
plt.plot(history.history['val_loss'], label='Val Loss')
plt.title('Compact CNN 27-Espèces HNR Loss')
plt.legend()

plot_path = os.path.join(DATASET_DIR, 'compact_27sp_hnr_history.png')
