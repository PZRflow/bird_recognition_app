...
def build_advanced_mynanet(input_shape=(64, 300, 1), num_classes=27):
    ...
    model = keras.Model(inputs, outputs, name="Advanced_MynaNet_27Sp")
    return model

model = build_advanced_mynanet(input_shape=INPUT_SHAPE_64, num_classes=NUM_CLASSES)
...
MODEL_SAVE_PATH = os.path.join(DATASET_DIR, 'best_model_mynanet_27sp_advanced.keras')
...
print("\n--- Training Advanced MynaNet (50 Epochs, Cosine Decay, Swish, SE-Blocks) ---")
print(f"Target Save Location: {MODEL_SAVE_PATH}")
...
print(f"\n==========================================")
print(f"Advanced MynaNet Validation Accuracy: {val_acc*100:.2f}%")
