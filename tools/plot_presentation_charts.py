...
# Force CPU mode for instant execution without CUDA lock
...
print("Fast loading 3 models on CPU...")
...
print("SUCCESS: All 3 presentation charts generated cleanly!")
