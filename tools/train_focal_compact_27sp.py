...
def build_compact_cnn_focal(input_shape=(128, 128, 1), num_classes=27):
    ...
    model = keras.Model(inputs, outputs, name="Compact_CNN_27Sp_Focal")
    return model

model = build_compact_cnn_focal(input_shape=INPUT_SHAPE_128, num_classes=NUM_CLASSES)
...
MODEL_SAVE_PATH = os.path.join(DATASET_DIR, 'best_model_compact_27sp_focal.keras')
...
print("\n--- Lancement de l'Entraînement Compact CNN FOCAL ---")
...
print(f"\n==========================================")
print(f"Meilleure Précision Compact CNN Focal: {val_acc*100:.2f}%")
print(f"==========================================")
