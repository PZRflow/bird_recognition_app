...
MODEL_PATH = os.path.join(DATASET_DIR, 'best_model_compact_pcen.keras')
...
print(f"Loading Compact CNN PCEN Keras model from {MODEL_PATH}...")
model = keras.models.load_model(MODEL_PATH, compile=False)

print("Converting Compact CNN PCEN to TFLite Float16...")
...
print(f"Successfully exported Compact CNN PCEN TFLite to {TFLITE_PATH} ({len(tflite_model) / 1024:.1f} KB)")

metadata = {
    "model_name": "ZamZam_Compact_CNN_PCEN_v3",
    "architecture": "Compact CNN + PCEN + Spectral Subtraction",
