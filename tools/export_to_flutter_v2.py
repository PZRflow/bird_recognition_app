...
MODEL_PATH = os.path.join(DATASET_DIR, 'saved_model_v2.keras')
FLUTTER_ASSETS_DIR = os.path.join(os.path.dirname(__file__), '..', 'assets', 'model')

if not os.path.exists(MODEL_PATH):
    raise Exception("Keras model not found. Please run train_local_v2.py first.")
...
tflite_dest = os.path.join(FLUTTER_ASSETS_DIR, 'bird_classifier_v2.tflite')
...
# Generate model_metadata_v2.json
metadata_dest = os.path.join(FLUTTER_ASSETS_DIR, 'model_metadata_v2.json')
metadata = {
    "model_file": "bird_classifier_v2.tflite",
...
print(f"File model_metadata_v2.json generated to {metadata_dest}")
